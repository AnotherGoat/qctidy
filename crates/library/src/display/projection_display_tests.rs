...
fn node_view_single_qubit_to_string() {
    let id_node = NodeView::new(ID, Position::new(0, 0), None, None, None, None);
    assert_eq!(id_node.to_string(), "ID at (0, 0)");

    let h_node = NodeView::new(H, Position::new(0, 1), None, None, None, None);
    assert_eq!(h_node.to_string(), "H at (0, 1)");

    let x_node = NodeView::new(X, Position::new(1, 0), None, None, None, None);
    assert_eq!(x_node.to_string(), "X at (1, 0)");

    let y_node = NodeView::new(Y, Position::new(1, 1), None, None, None, None);
    assert_eq!(y_node.to_string(), "Y at (1, 1)");

    let z_node = NodeView::new(Z, Position::new(2, 0), None, None, None, None);
    assert_eq!(z_node.to_string(), "Z at (2, 0)");

    let s_node = NodeView::new(S, Position::new(2, 1), None, None, None, None);
    assert_eq!(s_node.to_string(), "S at (2, 1)");

    let sdg_node = NodeView::new(SDG, Position::new(3, 0), None, None, None, None);
    assert_eq!(sdg_node.to_string(), "SDG at (3, 0)");

    let sx_node = NodeView::new(SX, Position::new(3, 1), None, None, None, None);
    assert_eq!(sx_node.to_string(), "SX at (3, 1)");

    let sy_node = NodeView::new(SY, Position::new(4, 0), None, None, None, None);
    assert_eq!(sy_node.to_string(), "SY at (4, 0)");

    let t_node = NodeView::new(T, Position::new(4, 1), None, None, None, None);
    assert_eq!(t_node.to_string(), "T at (4, 1)");

    let tdg_node = NodeView::new(TDG, Position::new(5, 0), None, None, None, None);
...
fn node_view_measurement_to_string() {
    let node = NodeView::new(Measure, Position::new(0, 0), None, None, None, Some(3));
    assert_eq!(node.to_string(), "M(bit=3) at (0, 0)");
}

#[test]
fn edge_view_right_to_string() {
    let start = NodeView::new(H, Position::new(0, 0), None, None, None, None);
    let end = NodeView::new(X, Position::new(0, 1), None, None, None, None);
...
fn edge_view_targets_to_string() {
    let start = NodeView::new(CX, Position::new(0, 0), None, None, None, None);
    let end = NodeView::new(CX, Position::new(1, 0), None, None, None, None);
...
fn edge_view_swaps_with_to_string() {
    let start = NodeView::new(Swap, Position::new(0, 0), None, None, None, None);
    let end = NodeView::new(Swap, Position::new(1, 0), None, None, None, None);
...
fn edge_view_works_with_to_string() {
    let start = NodeView::new(CCX, Position::new(0, 0), None, None, None, None);
    let end = NodeView::new(CCX, Position::new(1, 0), None, None, None, None);
...
fn edge_view_display_with_angles() {
    let start = NodeView::new(RX, Position::new(0, 0), Some(FRAC_PI_2), None, None, None);
    let end = NodeView::new(RX, Position::new(0, 1), Some(FRAC_PI_3), None, None, None);
    let edge = EdgeView::new(Right, start, end);
...
fn edge_view_display_with_bits() {
    let start = NodeView::new(Measure, Position::new(0, 0), None, None, None, Some(5));
    let end = NodeView::new(Measure, Position::new(0, 1), None, None, None, Some(0));
    let edge = EdgeView::new(Right, start, end);
...
fn contextual_node_view_to_string_origin_only() {
    let origin = NodeView::new(H, Position::new(0, 0), None, None, None, None);
...
fn contextual_node_view_to_string_with_left() {
    let origin = NodeView::new(X, Position::new(0, 1), None, None, None, None);
    let left = NodeView::new(H, Position::new(0, 0), None, None, None, None);
...
fn contextual_node_view_to_string_with_right() {
    let origin = NodeView::new(H, Position::new(0, 0), None, None, None, None);
    let right = NodeView::new(X, Position::new(0, 1), None, None, None, None);
...
fn contextual_node_view_to_string_with_left_and_right() {
    let origin = NodeView::new(Y, Position::new(1, 1), None, None, None, None);
    let left = NodeView::new(X, Position::new(1, 0), None, None, None, None);
    let right = NodeView::new(Z, Position::new(1, 2), None, None, None, None);
...
fn contextual_node_view_to_string_with_targets() {
    let origin = NodeView::new(CX, Position::new(0, 0), None, None, None, None);
    let target = NodeView::new(CX, Position::new(1, 0), None, None, None, None);
...
fn contextual_node_view_to_string_with_multiple_targets() {
    let origin = NodeView::new(CCX, Position::new(0, 0), None, None, None, None);
    let target1 = NodeView::new(CCX, Position::new(1, 0), None, None, None, None);
    let target2 = NodeView::new(CCX, Position::new(2, 0), None, None, None, None);
    let view = ContextualNodeView::new(
        origin,
        None,
        None,
...
fn contextual_node_view_to_string_with_controlled_by() {
    let origin = NodeView::new(CX, Position::new(1, 0), None, None, None, None);
    let controller = NodeView::new(CX, Position::new(0, 0), None, None, None, None);
...
fn contextual_node_view_to_string_with_swaps_with() {
    let origin = NodeView::new(Swap, Position::new(0, 0), None, None, None, None);
    let partner = NodeView::new(Swap, Position::new(1, 0), None, None, None, None);
...
fn contextual_node_view_to_string_with_works_with() {
    let origin = NodeView::new(CCX, Position::new(0, 0), None, None, None, None);
    let partner1 = NodeView::new(CCX, Position::new(1, 0), None, None, None, None);
    let partner2 = NodeView::new(CCX, Position::new(2, 0), None, None, None, None);
    let view = ContextualNodeView::new(
        origin,
        None,
        None,
...
fn contextual_node_view_to_string_with_all_relationships() {
    let origin = NodeView::new(CCX, Position::new(1, 1), None, None, None, None);
    let left = NodeView::new(ID, Position::new(1, 0), None, None, None, None);
    let right = NodeView::new(ID, Position::new(1, 2), None, None, None, None);
    let target = NodeView::new(CCX, Position::new(0, 1), None, None, None, None);
    let controller = NodeView::new(CCX, Position::new(2, 1), None, None, None, None);
    let partner = NodeView::new(CCX, Position::new(0, 1), None, None, None, None);
